...
function attachNewPhoto(ftrEditResult){
	...
	function(results){
		// alert("success!");
		$("#photoResponse")[0].innerHTML = "Your photo was succefully submitted. It will be reviewed before being added to the map.";
		$("#postPhotoSubmissionModal").modal('show');
	},
	function(error_results){
		$("#photoResponse")[0].innerHTML = "<p>There was an issue submitting your photo:" + error_results.details[0] + "</p>";
		$("#photoResponse")[0].innerHTML += "<p>The most likely cause is that your photo is larger than 10MB in size.</p>";
